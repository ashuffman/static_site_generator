...
def generate_site(from_path: str, template_path: str, dest_path: str):
    if not os.path.exists(from_path):
        raise Exception("Error: Invalid source directory file path")
    if not os.path.exists(dest_path):
        os.makedirs(dest_path)

    _generate_recursive(from_path, template_path, dest_path)
    
    return

def _generate_recursive(from_path: str, template_path: str, dest_path:str):
    ...
    for item in from_items:
        ...
        if os.path.isfile(item_path):
            ...
            _generate_recursive(item_path, template_path, item_dest_path)
